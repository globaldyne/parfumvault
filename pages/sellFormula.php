...
<div class="container-fluid">
	...
	<div class="card-body">
      ...
      <div class="row mb-3">
        <label for="formulaID" class="col-sm-1 col-form-label">Formula</label>
        <div class="col-sm-5">
      ...
      <div class="row mb-3">
        <label for="orientation" class="col-sm-1 col-form-label">PDF Orientation</label>
        <div class="col-sm-5">
      ...
      <div class="row mb-3">
        <label for="watermarkText" class="col-sm-1 col-form-label">Watermark</label>
        <div class="col-sm-5">
      ...
      <div class="row mb-3">
        <label for="watermarkTextOp" class="col-sm-1 col-form-label">Watermark size</label>
        <div class="col-sm-5">
      ...
      <div class="row mb-3">
        <label for="fontSize" class="col-sm-1 col-form-label">PDF font size</label>
        <div class="col-sm-5">
