	...
	<div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-3">
              <label for="watermarkText" class="col-form-label">Watermark</label>
              <div class="col-sm-9">
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-3">
              <label for="fontSize" class="col-form-label">PDF font size</label>
              <div class="col-sm-9">
            ...
            <div class="row mb-3">
              <label for="logoSizeW" class="col-form-label">Logo width (px)</label>
              <div class="col-sm-9">
            ...
            <div class="row mb-3">
              <label for="logoSizeH" class="col-form-label">Logo height (px)</label>
              <div class="col-sm-9">
