  ...
  <div class="text-right">
    <div class="btn-group" id="menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_ingredient_cat"><i class="fa-solid fa-plus mr2"></i>Add ingredient category</a></li>
        </div>
    </div>
  </div>
</div>
...
function ciImage(data, type, row){
	...
	return '<a href="#" data-id="'+row.id+'" data-toggle="modal" data-bs-target="#editCategory">' + cimg + '</a>';    
}
