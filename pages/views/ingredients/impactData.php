...
<hr>
<div class="container">
    <div class="row mb-3 col-sm-5">
        <label for="impact_top" class="col-form-label">Top</label>
    ...
    <div class="row mb-3 col-sm-5">
        <label for="impact_heart" class="col-form-label">Heart</label>
    ...
    <div class="row mb-3 col-sm-5">
        <label for="impact_base" class="col-form-label">Base</label>
