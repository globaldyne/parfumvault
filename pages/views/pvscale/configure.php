      ...
      success: function(data) {
        ...
        if (data.success === true) {
			...
			$('#sysData').html(
			 ...
			 msg = '<div class="alert alert-success"><i class="fa-solid fa-circle-check mx-2"></i>' + data.msg + '</div>';
        } else {
			$('#subScale').addClass('d-none');
         	msg = '<div class="alert alert-danger"><i class="fa-solid fa-triangle-exclamation mx-2"></i>Connection failed</div>';
        }
