    ...
    <div class="tab-pane fade show active" id="supplierPanel" role="tabpanel">
      ...
      <div class="col-sm">
        <div class="mb-2">
          ...
          <select name="supplier_name" id="supplier_name" class="form-select selectpicker" data-live-search="true">
      ...
      <div class="row">
        <div class="col-sm">
          <div class="mb-2">
            ...
            <select name="sdsCountry" id="sdsCountry" class="form-select selectpicker" data-live-search="true">
        ...
        <div class="col-sm">
          <div class="mb-2">
            ...
            <select name="sdsLang" id="sdsLang" class="form-select selectpicker" data-live-search="true">
