            ...
            <div class="card-body">
                ...
                ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <select name="concentration" id="concentration" class="form-control selectpicker"
                                data-live-search="true">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <select name="defCatClass" id="defCatClass" class="form-control selectpicker"
                                data-live-search="true">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div>
                            <select name="batch_id" id="batch_id" class="form-control selectpicker"
                ...
                ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <select name="accessory_id" id="accessory_id" class="form-control selectpicker"
                                data-live-search="true">
