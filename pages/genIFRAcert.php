...
<p  class="western"><font face="Arial, sans-serif"><span LANG="en-US"><B><span style="background: #ffff00">Name
...
<p class="western" align=JUSTIFY style="margin-right: -0.12in">
...
<p  class="western" align=JUSTIFY style="margin-right: -0.12in"><br>
</p>
<table WIDTH=662 CELLPADDING=7 CELLSPACING=0>
  <COL WIDTH=401>
	<COL WIDTH=231>
	<TR Valign=TOP>
		<TD WIDTH=401 HEIGHT=6 BGCOLOR="#d9d9d9" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><span ><I><B>IFRA
			Category(ies) [see Table 12 in Guidance for the use of IFRA
			Standards for details]</b></I></span></font></p>
		</TD>
		<TD WIDTH=231 BGCOLOR="#d9d9d9" style="border: 1px solid #000000; padding: 0in 0.08in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><B>Level of use (%)*</b></font></p>
		</TD>
	</TR>
	<TR Valign=TOP>
		<TD WIDTH=401 HEIGHT=7 style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><font SIZE=3><span ><I><B><span style="background: #ffff00">Category
			4</span></b></I></span></font></font></p>
		</TD>
		<TD WIDTH=231 style="border: 1px solid #000000; padding: 0in 0.08in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><font SIZE=3><span ><I><B><span style="background: #ffff00">12%</span></b></I></span></font></font></p>
		</TD>
	</TR>
	<TR Valign=TOP>
		<TD WIDTH=401 HEIGHT=6 style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><font SIZE=3><span ><I><B><span style="background: #ffff00">Category
			5.C</span></b></I></span></font></font></p>
		</TD>
		<TD WIDTH=231 style="border: 1px solid #000000; padding: 0in 0.08in">
			<p  class="western" align=center style="margin-right: -0in">
			<font face="Arial, sans-serif"><font SIZE=3><I><B><span style="background: #ffff00">2.1%</span></b></I></font></font></p>
		</TD>
	</TR>
</table>
<p  class="western" align=JUSTIFY style="margin-right: -0.12in">
<font face="Arial, sans-serif"><I>*Actual use level or maximum use level</I></font> </p>
<p  class="western" align=JUSTIFY style="margin-right: -0.12in">
...
<p class="western" align=JUSTIFY style="margin-right: -0.12in">&nbsp;</p>
<table width="61%" border="1">
  <tr>
    ...
    <th width="20%" bgcolor="#d9d9d9"><strong>Recommendation from IFRA Standard:</strong></th>
    <th width="46%" bgcolor="#d9d9d9"><strong>Concentration (%) in fragrance mixture or finished product:</strong></th>
  </tr>
    <?php 
...
<p>&nbsp;</p>
<p>&nbsp;</p>
  <font face="Arial, sans-serif"><span >Signature </span></font><font face="Arial, sans-serif"><span><I>(If generated electronically, no signature)</i></span></font><font face="Arial, sans-serif"><span >
  Date</span></font></p>
<div>
	<p align=JUSTIFY style="margin-right: 0in; margin-top: 0.08in">
	<font face="Segoe UI, sans-serif"><font SIZE=1 style="font-size: 8pt"><span><u>Disclaimer</u></span></font></font><font face="Segoe UI, sans-serif"><font SIZE=1 style="font-size: 8pt"><span>:
	This Certificate provides restrictions for use of the specified product based only on those materials restricted by IFRA Standards for the toxicity endpoint(s) described in each Standard. This Certificate does not provide certification of a comprehensive safety assessment of all product constituents. This certificate is the responsibility of the fragrance supplier issuing it. It has not been prepared or endorsed by IFRA in anyway. </span></font></font>
