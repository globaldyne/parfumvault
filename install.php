...
if($_GET['do']=='save'){		
	if(strlen($_POST['password']) < '5'){
		...
		if($_POST['dbhost'] && $_POST['dbuser'] && $_POST['dbpass'] && $_POST['dbname'] && $_POST['username'] && $_POST['password'] && $_POST['fullName']){
			...
			if(!$link = mysqli_connect($_POST['dbhost'], $_POST['dbuser'], $_POST['dbpass'], $_POST['dbname'])){
				...
				passthru($cmd,$e);
				if(!$e){
					mysqli_query($link,"INSERT INTO users (username,password,fullName) VALUES ('$_POST[username]',PASSWORD('$_POST[password]'),'$_POST[fullName]')");
