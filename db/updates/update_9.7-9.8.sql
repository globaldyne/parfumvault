...
ALTER TABLE `settings` ADD `pv_scale_enabled` INT NOT NULL DEFAULT '0' AFTER `pv_scale_host`; 
ALTER TABLE `settings` ADD `pv_host` VARCHAR(255) NOT NULL DEFAULT 'localhost' AFTER `pv_scale_enabled`; 