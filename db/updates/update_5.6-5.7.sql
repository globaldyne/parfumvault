...
ALTER TABLE `documents` ADD `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `docData`, ADD `updated` DATETIME on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `created`; 
